...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group well" action="adicionar_classificacao.php" method="POST">
    ...
    <div class="modal fade" id="myModalAlterar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group well" action="alterar_classificacao.php" method="POST">
    ...
    <div class="modal fade" id="myModalExcluir" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group well" action="excluir_classificacao.php" method="GET">
                        Codigo <input id="codigo" type="text" name="codigo" value="" required>
                        Nome <input id="nome" type="text" name="nome" class="span3" required value="" style=" margin-bottom: -2px; height: 25px;"><br><br>
    ...
    <div class="container">
        <div class="row">
            ...
            <h2>Lista de classificacao: </h2><br>
            <form action="tabela_classificacao.php" method="POST">
            ...
            <table border="1px" bordercolor="gray" class="table table-stripped">
                ...
                if ((isset($_POST['pesquisar'])) or isset($_POST['cadastrar']))
                {
                    ...
                    <tr>
                        ...
                        <td>
							<?php
								echo "<a href='excluir_classificacao.php?codigo=".$dados['codigo']."'><button class='btn btn-danger' type='button' name='excluir'>Excluir</button></a>";
							?>
